// A file of the constants held for each hero, This orginall info was ran through an a loop that returned a list of only the useful constants that where planned on being used for this project's pruposes.  
...
for (const key in heros){
    ...
    usefulstuff.push({
        heroId: hero['id'],
        info: {
            primeAttrtuibe:hero['primary_attr'],
...
for (item in usefulstuff){
    console.log(usefulstuff[item])
}
